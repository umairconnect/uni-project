...
<div class = "col-sm-4">
<form name ="Student" method = "GET"   action="admin.php">

<input type="submit" style="width: 400px; font-size : 40px; height: 80px; text-align:center; color:red;" value = "View List item" />
